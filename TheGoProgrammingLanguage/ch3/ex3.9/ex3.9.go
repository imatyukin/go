// Упражнение 3.9.
// Напишите программу веб-сервера, который визуализирует фракталы и выводит данные изображения клиенту. Позвольте
// клиенту указывать значения х,у и масштабирования в качестве параметров HTTP-запроса.
