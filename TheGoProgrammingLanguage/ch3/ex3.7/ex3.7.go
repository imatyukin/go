// Упражнение 3.7.
// Еще один простой фрактал использует метод Ньютона для поиска комплексных решений уравнения z4-1 = 0. Закрасьте
// каждую точку цветом, соответствующим тому корню из четырех, которого она достигает, а интенсивность цвета должна
// соответствовать количеству итераций, необходимых для приближения к этому корню.
